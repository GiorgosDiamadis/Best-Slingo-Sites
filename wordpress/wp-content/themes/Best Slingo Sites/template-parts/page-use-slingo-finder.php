    ...
    <div class="container">
        <header class="flex justify-center align-center d-column">
            <div class="casino-finder" id="casinoFinder" style="margin-top: 5rem;margin-bottom: 5rem">
                ...
                <div id="step-1">
                    <div class="row mt-4 game-list" data-page="0">
						<?php
						$gamesRes = "";
                    ...
                    <button class="button button-orange" data-finder="next-step" style="float: right">Next step</button>
                </div>
                ...
                <div class="d-none" id="step-3">
                    ...
                    <div class="buttons" style="text-align:end">
                        <button class="button button-orange" data-finder="back-step">Back</button>
                        <button class="button button-orange" data-finder="find-casino" onclick="findCasinos(this,'casino','.casino-search')"
                        >Find Casino
                        </button>
                    </div>
