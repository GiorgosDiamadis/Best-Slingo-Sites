...
<div class="footer">
    <div class="container-xxl">
        ...
        <a style="display:inline;" class="footer-img" aria-label="be gamble aware" href="https://www.begambleaware.org/">
            <img width="212" height="30" src="<?= $helper->GetImage( 'begambleaware.webp' ) ?>" alt=" gamble aware image"
                 style="background-color: aliceblue;border-radius: 10px;" class="mt-4 mb-2">
        </a>
        <a style="display:inline;" aria-label="gamcare" class="footer-img" href="https://www.gamcare.org.uk/">
            <img width="111" height="40" src="<?= $helper->GetImage( 'gamcare.webp' ) ?>" alt="gambling care image"
                 style="background-color: aliceblue;border-radius: 10px;margin-left: 2rem" class="mt-4 mb-2">

        </a>
        <a aria-label="gamstop" style="display:inline;" class="footer-img" href="https://www.gamstop.co.uk/ ">
            <img width="153" height="30" src="<?= $helper->GetImage( 'gamstop.webp' ) ?>" alt=" game stop image"
                 style="margin-left: 2rem" class="mt-4 mb-2">

        </a>
        <a aria-label="18+" style="display:inline;" href="#" onclick="return false" class="footer-img">
            <img width="40" height="40" src="<?= $helper->GetImage( '18+.webp' ) ?>" alt="18 plus image" style="margin-left: 2rem"
                 class="mt-4 mb-2">
        </a>
...
<img width="48" height="48" onclick="window.scrollTo(0,0)" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/scrolltop.png" id="scrolltop" alt="Scroll top icon">


<script nonce="random123" src="<?= get_template_directory_uri() . '/jquery.min.js'?>"></script>
<script nonce="random123" src="<?= get_template_directory_uri() . '/bootstrap.bundle.min.js'?>"></script>

<script nonce="random123" src="<?= get_template_directory_uri() . '/main.js?ver=' . filemtime( dirname( __FILE__ ) . '/main.js' ) ?>"></script>
<script nonce="random123" src="<?= get_template_directory_uri() . "/api.js?ver=" . filemtime( dirname( __FILE__ ) . '/api.js' ) ?>"></script>
<script nonce="random123" src="<?= get_template_directory_uri() . "/UiBuilder.js?ver=" . filemtime( dirname( __FILE__ ) . '/UiBuilder.js' ) ?>"></script>
