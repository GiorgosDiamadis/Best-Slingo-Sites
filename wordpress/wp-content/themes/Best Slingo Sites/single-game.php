        ...
        <header class="justify-center align-center">
            ...
            <div class="game-single">
                <div data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?= $adDisclosure ?>"
                    ...
                    <img src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/info_24px.png" width="20"
                         height="20" alt="">
                ...
                <div class="modal-content" style="height: 100%">
                    ...
                    <div class="modal-body">
                        <h3 style="text-align:center">
                            ...
                            Notice for UK Players
                        </h3>
                        <p class="mt-3">
                            Free Play in the UK now requires sign-in

                            (new UK Government law)

                            In order to play for free please <a target="_blank" rel="nofollow"
                                                                href="https://www.slingooriginals.com/">visit the
                                official Slingo Originals site</a>.
                    ...
                    <div class="modal-footer">
                        <button class="button button-green"><a style="margin-top: 0" rel="nofollow" target="_blank"
                                                               href="https://www.slingooriginals.com/">Visit official
                                site</a></button>
                        <button type="button" onclick="unload()"
                                class="button button-orange" data-bs-dismiss="modal">Cancel
                        </button>
                    </div>
                </div>
            </div>
        ...
        <section class="section-grey ">
            ...
            <div class="row game-details mt-5">
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/theme.png"
                         alt="theme icon">
                ...
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/money.png"
                         alt="max bet icon">
                    <div class="flex d-column game-features">
                ...
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/gift.png"
                         alt="free spins icon">
                    <div class="flex d-column  game-features">
                ...
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42"
                         src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/growth.png"
                         alt="volatility icon">
                    <div class="flex d-column  game-features">
                ...
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/happy.png"
                         alt="extra spins icon">
                    <div class="flex d-column game-features ">
                ...
                <div class="col-lg-4 col-6 flex mb-5" style="gap: 10px">
                    <img width="44" height="42"
                         src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/burger.png" alt="rtp icon">
                    <div class="flex d-column  game-features">
                        <p class="bold">RTP </p>
                        <p><?= $meta['other'][0] ?? "" ?></p>
                    </div>
