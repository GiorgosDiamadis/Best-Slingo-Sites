...
<!--    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;700&display=swap" rel="stylesheet">-->
    ...
    <script nonce="random123" async src="https://www.googletagmanager.com/gtag/js?id=UA-210004563-1"></script>
	<script nonce="random123" src="<?= get_template_directory_uri() . '/googlatagmanager.js'?> "></script>
...
<nav class="navbar sticky-top navbar-expand-lg bg-dark navbar-dark">
    <div class="container-xxl">
        <a aria-label='Website Logo' class="navbar-brand" id="navLogo" href="<?= get_home_url() ?>">
            <img width="190" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/logo.png" alt="website logo">
