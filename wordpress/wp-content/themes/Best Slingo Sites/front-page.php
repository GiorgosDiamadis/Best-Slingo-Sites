    ...
    <div class="container">
        <header class="flex justify-center align-center d-column">
            <div class="w-100 header-title">
                <div>
                    <h1 style="color: white">Find The Best Slingo Sites</h1>
                    <h5 class="mt-5 hide-1000" style="color: white">Use slingo sites
                        finder and find the best casino for your needs in just 3 steps</h5>
                </div>
                <img class="hide-1000" src="https://bestslingosites.co.uk/wp-content/uploads/2022/06/slingo.png" alt="">
            </div>
            <div class="casino-finder" id="casinoFinder">
